...
```
#### **There are duplicated rows?**  `r if(flag_empty == 0){if(flag_duplicates_rows == 0){paste("NO: all right!")}}` `r if(flag_empty == 0){if(flag_duplicates_rows == 1){paste("YES: there are duplicated rows!")}}` `r if(flag_empty == 1){paste("- - -")}` 
...
#### **There are some missing dates?** `r if(flag_empty == 0){if(flag_overlap == 0){if(flag_missing_dates == 0){paste("NO: all right!")}}}` `r if(flag_empty == 0){if(flag_overlap == 0){ if(flag_missing_dates == 1){paste("YES: there are missing dates!")}}}` `r if(flag_empty == 1){paste("- - -")}`
...
#### **Which values are out of physical range?** 
 ...
 `r if(flag_empty == 0){if(flag_overlap == 1){paste("Before continuing, solve previous problems!")}}` `r if(flag_empty == 0){paste("Warning: File empty!")}` `r if(flag_empty == 1){paste("- - -")}`
