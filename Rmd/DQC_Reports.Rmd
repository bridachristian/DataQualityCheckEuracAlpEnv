...
if(errors_list_report_errors$err_out_of_range$Status == "Y"){ 
  ...
  for(i in 1:length(vars)){
    ...
    # print(kable(tab_var[order(tab_var$From),],row.names = F),type = "html")
    print(xtable(tab_var_v0[order(tab_var_v0$From),],row.names = F),type = "html",include.rownames=FALSE)
