...
if(write_output == TRUE){
  ...
  out_filename =  paste(substring(mydata[nrow(mydata),which(colnames(mydata) == DATETIME_HEADER)],1,4),
    ...
    # substring(FILE,1,nchar(FILE)-4),
    #                     "_",
    #                     substring(mydata[1,which(colnames(mydata) == DATETIME_HEADER)],1,4),
    #                     substring(mydata[1,which(colnames(mydata) == DATETIME_HEADER)],6,7),
    #                     substring(mydata[1,which(colnames(mydata) == DATETIME_HEADER)],9,10),
    #                     # "_",
    #                     substring(mydata[1,which(colnames(mydata) == DATETIME_HEADER)],12,13),
    #                     substring(mydata[1,which(colnames(mydata) == DATETIME_HEADER)],15,16),
    #                     "-",
    #                     )
