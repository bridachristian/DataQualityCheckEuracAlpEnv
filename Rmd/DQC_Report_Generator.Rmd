...
flag_empty = flags_df[1,]
flag_error_df = flags_df[2,]
flag_date = flags_df[3,]
flag_duplicates_rows = flags_df[4,]
flag_overlap = flags_df[5,]
flag_missing_dates = flags_df[6,]
flag_range_variable_to_set = flags_df[7,]
flag_range_variable_new = flags_df[8,]
flag_out_of_range = flags_df[9,]
...
Timeseries has **`r nrow(mydata)`** samples 
