...
FILE <- "M0.dat"                                      # <-- Write here the file or the list of file  that you want to analyze!
# cat("Selected files: \n", FILE)
...
#### **Do you need updates to the range file?** `r if(flag_empty == 1){paste("- - -")}` `r if(flag_empty == 0){if(flag_error_df != 0){paste("- - -")}}` `r if(flag_empty == 0){if(flag_error_df == 0){if(flag_overlap == 0){if(length(variable_not_in_range_file) == 0){paste("No, the range file is up to date!")}else{paste("YES, update limits of the following variables")}}}}`
