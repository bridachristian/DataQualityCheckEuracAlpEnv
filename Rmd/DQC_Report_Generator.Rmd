...
Timeseries start at **`r mydata[1,which(colnames( mydata) == datetime_header)]`** and end at **`r mydata[nrow(mydata),which(colnames( mydata) == datetime_header)]`** 
        ...
        if(flag_missing_dates == 1){
          ...
          ggplot(df_missing,aes(x = time, y=y ,colour = Status)) +  
            ...
            labs(title="Time distribution of missing dates",
                 subtitle=paste("Total missing dates: ", tot_missing," (/",nrow(mydata),")",sep = ""))
        }
      }
    }
  }
              ...
              if(any(unique(df_oor[,2])!= 0)){
                ...
                p1 = ggplot(df_factor,aes(x = time, y = y,colour = Variable))+
                  ...
                  labs(title=paste(colnames(check_out_of_range)[j]),
                       subtitle=paste("Total Above upper limit: ", how_many_over_range, " (/",nrow(mydata),")", "\n",
                                      "Total Below lower limit: ", how_many_under_range," (/",nrow(mydata),")", sep = ""))
