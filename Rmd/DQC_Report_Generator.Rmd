...
FILE <- "M1.dat"                                      # <-- Write here the file or the list of file  that you want to analyze!
# cat("Selected files: \n", FILE)
...
start_date <- "2017-12-03 09:00:00"
# .....................................................................................................................................................
...
if(flag_overlap == 0){
  ...
  if(length(which(time_tot %in% time_missing )) == 0){
    ...
    flag_missing_dates = 1
    
  }
}
```

#### **There are some missing dates?** `r if(flag_overlap == 0){paste("NO: all right!")}` `r if(flag_overlap == 1){paste("YES: there are missing dates!")}`
...
`r if(flag_overlap == 0){paste("There isn't any missing dates!")}``r if(flag_overlap == 1){paste("Statistics of missing dates:!")}`
