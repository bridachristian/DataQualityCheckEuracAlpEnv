  ...
  if(flag_error_df == 0){
    ...
    if(flag_date == 0){
      ...
      out_lastdate_orig = paste(substring(lastdate_orig,1,4),
                                ...
                                sep = "")
      orig_filename = paste(substring(file, 1, nchar(file)-4),"_", out_lastdate_orig,".dat", sep = "")
      
      if(file.exists(paste(output_dir_data,orig_filename,sep = ""))){
            j=0
            repeat{
              j=j+1
              out_filename_orig_new = paste(substring(orig_filename,1, nchar(orig_filename)-4),"_",j,".dat",sep = "")
