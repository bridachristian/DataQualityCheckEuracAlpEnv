...
```
#### **There are duplicated rows?**  `r if(flag_duplicates_rows == 0){paste("NO: all right!")}` `r if(flag_empty == 1){paste("YES: there are duplicated rows!")}`

`r if(flag_duplicates_rows == 0){paste("There isn't any duplicated row")}`
`r if(flag_duplicates_rows == 1){paste("Attention: there are duplicated row in input file. See:", paste(output_dir,"Duplicated_",substring(FILE,1,nchar(FILE)-4),".csv",sep = ""))}`


#### **There are overlaps? ** `r if(flag_overlap == 0){paste("NO: all right!")}` `r if(flag_overlap == 1){paste("YES: there are overlaps!")}`


`r if(flag_overlap == 1){paste("There are the following ovelap:")}else{paste("There isn't any overlap!")}`
...
#### **There are some missing dates?** `r if(flag_overlap == 0){if(flag_missing_dates == 0){paste("NO: all right!")}}` `r if(flag_overlap == 0){ if(flag_missing_dates == 1){paste("YES: there are missing dates!")}}`

`r if(flag_overlap == 1){paste("Before continuing, solve previous problems!")}`
...
`r if(flag_overlap == 0){if(flag_missing_dates == 0){paste("There isn't any missing dates!")}}` `r if(flag_overlap == 0){if(flag_missing_dates == 1){paste("Statistics of missing dates:!")}}`
