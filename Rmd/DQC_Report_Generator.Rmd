...
#### **Do you need to update the range file?** `r if(is.na(flag_range_variable_to_set)){paste("- - -")}else{if(flag_range_variable_to_set == 0){paste("NO, the range file is up to date!")}else{if(flag_range_variable_to_set == 1){paste("YES, update limits of the following variables")}}} `
