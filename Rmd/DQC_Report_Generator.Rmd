...
if(check_empty_file(INPUT_DATA_DIR = input_dir, FILE_NAME = file) == TRUE){
  ...
  if(flag_error_df == 0){
    ...
    if(flag_date == 0){
      ...
      write.csv(orig_wihtout_dupli,paste(output_dir_data,substring(file, 1, nchar(file)-4),"_", out_lastdate_orig,".dat", sep = ""),quote = F,row.names = F, na = "NaN")      # <- write "origina data"
