    ...
    if(flag_date == 0){
      if(flag_overlap == 0){
        ...
        if(flag_range_variable_new == 1){
          df_variable_new = data.frame(variable_new)
          colnames(df_variable_new) = "Variable"
          print("New variables add in range file. Set thresholds!")
          print(kable(df_variable_new, format = "html",align = "c",row.names = F)%>%
            kable_styling() %>%
            scroll_box( height = "200px"))
        }else{
        ...
        if(flag_range_variable_to_set == 1){
          df_variable_to_set = data.frame(variable_to_set)
          colnames(df_variable_to_set) = "Variable"
          print("Remember to update thresholds for these variables in range file")
          print(kable(df_variable_to_set, format = "html",align = "c",row.names = F)%>%
            kable_styling() %>%
            scroll_box( height = "200px")) 
...
`r if(!is.na(flag_range_variable_to_set)){paste(t1)}else{paste("Before continuing, solve previous problems!")} `
...
<!-- `r if(flag_empty == 1){paste("- - -")}` `r if(flag_empty == 0){if(flag_error_df != 0){paste("- - -")}}` `r if(flag_empty == 0){if(flag_error_df == 0){if(flag_date != 0){paste("- - -")}}}` `r if(flag_empty == 0){if(flag_error_df == 0){if(flag_date == 0){if(flag_overlap == 0){if(flag_range_variable_to_set == 1){paste("- - -")}}}}}` `r if(flag_empty == 0){if(flag_error_df == 0){if(flag_date == 0){if(flag_overlap == 0){if(flag_range_variable_to_set == 0){if(flag_out_of_range == 0){paste("No data out of range")}}}}}}` -->


`r if(is.na(flag_out_of_range)){paste("Before continuing, solve previous problems!")}`

<!-- `r if(flag_empty == 0){if(flag_error_df == 0){if(flag_date == 0){if(flag_overlap == 0){if(flag_range_variable_to_set == 1){paste("Before continuing, set range limits for previous variables!")}}}}}` -->
...
if(flag_empty == 0){
  if(flag_error_df == 0){
    if(flag_date == 0){
      if(flag_overlap == 0){
        if(flag_range_variable_to_set == 0){
