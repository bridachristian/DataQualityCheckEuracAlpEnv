...
#' @param DATETIME_FORMAT format of data corresponding to datetime
...
exclude_out_of_range_v2 = function(DATA,DATETIME_HEADER = "TIMESTAMP",DATETIME_FORMAT = "%Y-%m-%d %H:%M",RECORD_HEADER, RANGE_DIR, RANGE_FILE){
  options(scipen = 999)
