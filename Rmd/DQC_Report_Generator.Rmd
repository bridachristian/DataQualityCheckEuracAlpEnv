...
`r if(flag_empty == 0){if(flag_error_df == 1){paste("1. row shifted above. 2. new data with old headers. 3. other file manipulation errors.")}}` 
...
```
#### **There are duplicated rows?**  `r if(flag_empty == 0){if(flag_error_df == 0){if(flag_overlap == 1){if(flag_duplicates_rows == 0){paste("NO: all right!")}}}}` `r if(flag_empty == 0){if(flag_error_df == 0){if(flag_overlap == 1){if(flag_duplicates_rows == 1){paste("YES: there are duplicated rows!")}}}}` `r if(flag_empty == 1){paste("- - -")}` `r if(flag_empty == 0){if(flag_error_df == 1){paste("- - -")}}` 

`r if(flag_empty == 0){if(flag_error_df == 0){if(flag_overlap == 1){if(flag_duplicates_rows == 0){paste("There isn't any duplicated row")}}}}`
`r if(flag_empty == 0){if(flag_error_df == 0){if(flag_overlap == 1){if(flag_duplicates_rows == 1){paste("Attention: there are duplicated row in input file. See:", paste(output_dir,"Duplicated_",substring(FILE,1,nchar(FILE)-4),".csv",sep = ""))}}}}`
